...
const DIALECT_CARDS: DialectCard[] = [
  {
    ...
    label:     "Standard",
    nameBn:    "মান বাংলা",
    region:    "The Busy Metropolis",
    desc:      "The official language of Bangladesh. Spoken by 170M+ people and the lingua franca of the nation.",
    color:     T.green,
    icon:      "globe-outline",
    available: true,
  },
  {
    ...
    label:     "Sylheti",
    nameBn:    "সিলেটি",
    region:    "Tea Garden Valley",
    desc:      "The lilting dialect of the northeast hills. Carried by ~11M speakers across the UK diaspora.",
    color:     T.sylheti,
    icon:      "cafe-outline",
    available: true,
  },
  {
    ...
    label:     "Barisali",
    nameBn:    "বরিশালি",
    region:    "Venice of the East",
    desc:      "The poetic dialect of the southern river delta. Known for warmth, music, and river lore.",
    color:     T.barisali,
    icon:      "boat-outline",
    available: true,
  },
  {
    ...
    label:     "Chatgaiya",
    nameBn:    "চাটগাঁইয়া",
    region:    "Coastal Port Heritage",
    desc:      "Ancient dialect of the sea trade routes. Spoken by ~13M in Bangladesh's great port city.",
  ...
  },
  {
    ...
    label:     "Rajshahi",
    nameBn:    "রাজশাহী",
    region:    "Off the Silk Trails",
    desc:      "The silk-and-mango dialect from the northwest plains. Soft, rural, and deeply melodic.",
    color:     "#059669",
    icon:      "leaf-outline",
    available: true,
  },
  {
    ...
    label:     "Khulna",
    nameBn:    "খুলনা",
    region:    "The Sundarban Delta",
    desc:      "Gateway to the world's largest mangrove forest. Steeped in fishing, tides, and river life.",
    color:     "#0891b2",
    icon:      "water-outline",
    available: true,
  },
