    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-white flex flex-col items-center justify-center px-6">
      ...
      <div className="card p-8 w-full max-w-sm space-y-4">
        ...
        >
          <button
            type="submit"
            className="w-full flex items-center justify-center gap-3 border-2 border-gray-200 rounded-2xl py-4 px-6 font-bold text-gray-700 hover:bg-gray-50 transition-colors"
          >
        ...
        <form
          action={async (formData: FormData) => {
            ...
            await signIn("resend", { email, redirectTo: "/learn" });
          }}
          className="space-y-3"
        >
          <input
            ...
            required
            className="w-full border-2 border-gray-200 rounded-2xl py-3 px-4 focus:outline-none focus:border-green-400 transition-colors"
          />
